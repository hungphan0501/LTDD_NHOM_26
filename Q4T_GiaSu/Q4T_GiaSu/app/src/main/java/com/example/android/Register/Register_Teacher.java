...
public class Register_Teacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genderList.add("Nam");
        genderList.add("Nữ");
        ArrayAdapter genderAdapter = new ArrayAdapter(Register_Teacher.this, R.layout.support_simple_spinner_dropdown_item, genderList);
    ...
    private void chonngay(TextView textView) {
        ...
        DatePickerDialog datePickerDialog=new DatePickerDialog(Register_Teacher.this, new DatePickerDialog.OnDateSetListener() {
            @Override
