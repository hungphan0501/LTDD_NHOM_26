...
public class messFragment extends Fragment {
    ...
    private List<mess> getMessList(){
        ...
        list.add(new mess(R.drawable.avt,"Phan Thiện","Lớp học vui lắm em", R.drawable.ic_check));
        list.add(new mess(R.drawable.avt,"Trần Quân","Em học không á?", R.drawable.ic_check));
        list.add(new mess(R.drawable.avt,"Huynh Thịnh","Cho em tham gia lớp với ạ", R.drawable.ic_check));
        list.add(new mess(R.drawable.avt,"Võ Thành Tiến","Lớp hết slot r nha e", R.drawable.ic_check));
        list.add(new mess(R.drawable.avt,"Võ Quang Tấn","Không học thôi anh không ép", R.drawable.ic_check));
        return list;
    }
}
