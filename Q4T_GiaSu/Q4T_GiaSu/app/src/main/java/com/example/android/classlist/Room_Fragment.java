...
public class Room_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Room room = (Room) bundle.getSerializable("data");
       // Toast.makeText(getActivity(), "" + id + teacherClass.getLesson_detail_id() + teacherClass.getId(), Toast.LENGTH_SHORT).show();

        txt_hocPhi.setText((room.getFee()) + "VND");
//        txt_soBuoi.setText(room.getNumber());
//        txt_soGio.setText(room.getHour());
        txt_monHoc.setText(room.getSubject());
        txt_lop.setText(room.getGrade());
        txt_diaChi.setText(room.getAddress());
        if (room.getMethod() == "1") {
        ...
        btn_nhapLop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<String> callback = dataClient.insertLesson(room.getLesson_detail_id(), id, room.getUser_id());
